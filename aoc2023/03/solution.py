...
touch = lambda s, n: abs(n[1] - s[1]) <= 1 and s[2] + 1 >= n[2] and s[2] <= n[3]
...
# Part 2: for each '*' symbol, build a list of adjacent numbers, then add their product to the total if there are exactly 2
